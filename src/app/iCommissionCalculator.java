...
public interface iCommissionCalculator {
	...
	/**
	 * DZ public static final int REPLACEMNET_ITEM = 3;
	 * DZ Corrected incorrect constant
	 * DZ Constant was 3, same as constant for CONSULTING_ITEM type 
	 * DZ It is suppose to be 2 so that all the types are different and in order
	 */
